 ...
 */
public class CategoriaActividadEconomica {
    ...
    public CategoriaActividadEconomica(String id, String nombre, String descripcion, String version, int modificado) {
        this.id = id;
        this.nombre = nombre;
    ...
    public int esMasReciente(CategoriaActividadEconomica match) {
    ...
    public boolean compararCon(CategoriaActividadEconomica otro) {
