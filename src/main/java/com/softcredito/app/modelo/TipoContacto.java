...
public class TipoContacto {
    ...
    public TipoContacto(String id, String nombre, String descripcion, String version, int modificado) {
        this.id = id;
        this.nombre = nombre;
    ...
    public int esMasReciente(TipoContacto match) {
    ...
    public boolean compararCon(TipoContacto otro) {
