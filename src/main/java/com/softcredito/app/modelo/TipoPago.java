...
public class TipoPago {
    ...
    public TipoPago(String id, String nombre, String descripcion, String version, int modificado) {
        this.id = id;
        this.nombre = nombre;
    ...
    public int esMasReciente(TipoPago match) {
    ...
    public boolean compararCon(TipoPago otro) {
